...
TRANSACTIONS = Table(
    'etherlink_transactions', metadata,
    Column('hash', VARCHAR, primary_key=True),
...
TOKEN_TRANSFERS = Table(
    'etherlink_token_transfers', metadata,
